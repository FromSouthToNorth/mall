...
<head>
    <title>登录</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resource/assets/css/login.css">
    <script src="${pageContext.request.contextPath}/resource/assets/js/jquery-3.4.1.js"></script>
</head>
<style>
    * {
        padding: 0;
            ...
            <div class="dialog dialog_shadow" style="display: block; margin-top: -362px">
                ...
                <div class="content">
                    ...
                    <div style="margin-top: 25px;">
                        <input class="main-btn" id="login" type="button" value="登录"
